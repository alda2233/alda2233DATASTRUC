...
class Queue:
    ...
    def is_full(self):
        ...
        -------------------------------------------------------
        """
        result = self._count == self._capacity
        return result
    ...
    def __eq__(self, target):
        ...
        if not isinstance(target, Queue):
            ...
            for value1, value2 in zip(self, target):
                if value1 != value2:
                    equals = False
                    break
    ...
    def insert(self, value):
        ...
        self._rear = (self._rear + 1) % self._capacity  # Use _capacity instead of _max_size
        self._count += 1
        return None
    ...
    # Update _front for circular queue
        self._front = (self._front + 1) % self._capacity

        self._count -= 1

    # Check if the queue is now empty and adjust _front accordingly
        if self._count == 0:
            self._front = None
